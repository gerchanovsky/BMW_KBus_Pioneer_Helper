...
#include "Adafruit_SSD1306_SH1106.h"
//AG:#include "splash.h"
...
void Adafruit_SSD1306::display(void) {
  TRANSACTION_START
#if !defined(SH1106_128_64)  //AG:start
  ...
  if(wire) { // I2C
#ifdef SH1106_128_64 //AG:start
    //ssd1306_command(SSD1306_SETLOWCOLUMN | 0x0);  // low col = 0
    //ssd1306_command(SSD1306_SETHIGHCOLUMN | 0x0);  // hi col = 0
    //ssd1306_command(SSD1306_SETSTARTLINE | 0x0); // line #0
    int idx = 0;
    #define SH1106_COL_SHIFT 2 /* for some reason display is shifted by 2 columns on 1.3" displays from ebay */
    ssd1306_command(SH1106_SETSTARTPAGE + idx/WIDTH);//set page address
    ssd1306_command(SSD1306_SETLOWCOLUMN  | (SH1106_COL_SHIFT & 0xf));//set lower column address
    ssd1306_command(SSD1306_SETHIGHCOLUMN | (SH1106_COL_SHIFT >> 4));//set higher column address
#endif
    wire->beginTransmission(i2caddr);
